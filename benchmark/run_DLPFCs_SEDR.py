...
import numpy as np
import pandas as pd
sys.path.append("/home/zzq/zzq/SEDR-master")
...
# ################ Path setting
data_root = '/home/zzq/zzq/DeepST-main/data/data/DLPFC'
...
save_root = '/home/zzq/zzq/DeepST-main/Benchmark/SEDR_results'
...
for proj_idx in range(len(proj_list)):
    ...
    sc.pl.spatial(adata_sedr,img_key=None, color=['SEDR_leiden'], show=False)
    plt.savefig(f'{params.save_path}/SEDR_leiden_plot1.jpg', bbox_inches='tight', dpi=150)
